...
namespace ActionEventService
{
    public class Service : IReceiveActionEventService
    {
        ...
        public Service() : this(DependencyFactory.Resolve<IActionEventManager>()) { }

        public Service(IActionEventManager actionEventManager) { _actionEventManager = actionEventManager; }
