...
{
    public abstract class StatusDocumentBuilder : IStatusDocumentBuilder
    {
        ...
        public Document BuildDocument(Order reswareOrder, eClosings.Entities.Orders.Order eClosingOrder)
        {
        ...
        protected internal void AddFeeSchedule(DocumentBuilder documentBuilder, eClosings.Entities.Orders.Order eClosingOrder)
        {
            documentBuilder.ParagraphFormat.ClearFormatting();
            documentBuilder.Font.ClearFormatting();
        ...
        protected internal abstract void AddBody(DocumentBuilder documentBuilder, Order reswareOrder, eClosings.Entities.Orders.Order eClosingOrder);
    }
}
