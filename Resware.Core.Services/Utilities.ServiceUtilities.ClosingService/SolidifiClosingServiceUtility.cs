...
namespace Resware.Core.Services.Utilities.ServiceUtilities.ClosingService
{
    internal class SolidifiClosingServiceUtility : ServiceUtility
    {
        ...
        private static void DetermineDelawareServices(ReswareRequestOrder requestClosingMessage)
        {
        ...
        private static void DetermineGeorgiaServices(ReswareRequestOrder requestClosingMessage)
        {
        ...
        private static void DetermineMassachusettsServices(ReswareRequestOrder requestClosingMessage)
        {
            if (string.Equals(requestClosingMessage.CustomerProduct, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase)
                && string.Equals(requestClosingMessage.Product, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase))
            {
        ...
        private static void DetermineNorthCarolinaServices(ReswareRequestOrder requestClosingMessage)
        {
            if (string.Equals(requestClosingMessage.CustomerProduct, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase)
                && string.Equals(requestClosingMessage.Product, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase))
            {
        ...
        private static void DetermineNewYorkServices(ReswareRequestOrder requestClosingMessage)
        {
            if (string.Equals(requestClosingMessage.CustomerProduct, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase)
                && string.Equals(requestClosingMessage.Product, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase))
            {
        ...
        private static void DetermineVermontServices(ReswareRequestOrder requestClosingMessage)
        {
            if (string.Equals(requestClosingMessage.CustomerProduct, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase)
                && string.Equals(requestClosingMessage.Product, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase))
            {
        ...
        private static void DetermineWestVirginiaServices(ReswareRequestOrder requestClosingMessage)
        {
            if (string.Equals(requestClosingMessage.CustomerProduct, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase)
                && string.Equals(requestClosingMessage.Product, ProductNameConstants.EClosingsProductNames.Refinance, StringComparison.CurrentCultureIgnoreCase))
            {
